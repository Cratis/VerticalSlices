...
public class with_past_tense_command_name : Specification
{
    ...
    void Establish()
    {
        var command = new Command("OrderPlaced", "An order was placed", [], "OrderId");
    ...
    [Fact] void should_reference_the_command_name() => _result[0].ArtifactName.ShouldEqual("OrderPlaced");
}
