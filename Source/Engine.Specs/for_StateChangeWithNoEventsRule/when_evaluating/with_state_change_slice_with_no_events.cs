...
namespace Cratis.VerticalSlices.for_StateChangeWithNoEventsRule.when_evaluating;

public class with_state_change_slice_with_no_events : Specification
{
    ...
    void Because() => _result = new StateChangeWithNoEventsRule().Evaluate(_modules).ToList();
    ...
    [Fact] void should_mention_event_in_the_message() => _result[0].Message.ShouldContain("event");
}
