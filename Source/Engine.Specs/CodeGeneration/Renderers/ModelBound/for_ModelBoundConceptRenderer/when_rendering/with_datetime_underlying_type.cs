...
/// <summary>
/// A DateTime concept should expose a static NotSet field initialised to new(DateTime.MinValue).
/// </summary>
public class with_datetime_underlying_type : given.a_context
{
    ...
    void Establish()
    {
        ...
        _descriptor = new ConceptDescriptor("EventTimestamp", "DateTime", "A timestamp of an event", []);
    }

    void Because() => _conceptContent = _renderer.Render(_descriptor, _context)
        .Single(f => f.RelativePath.EndsWith("EventTimestamp.cs")).Content;
