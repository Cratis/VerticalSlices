...
public class a_real_engine : Specification
{
    ...
    protected IEnumerable<RenderedArtifact> _generatedFiles;
    ...
    void WriteProjectFile()
    {
        ...
        // Seed an empty GlobalUsings.g.cs so that AddGlobalUsingsFromRenderedArtifacts() can append
        // cross-namespace usings to it later.  Framework usings (MongoDB.Driver, etc.) are now
        // emitted per-file by the renderers themselves.
        File.WriteAllText(Path.Combine(_outputDirectory, "GlobalUsings.g.cs"), string.Empty);
    }
    ...
    /// </summary>
    protected void AddGlobalUsingsFromRenderedArtifacts()
    {
